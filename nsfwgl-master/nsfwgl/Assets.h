...
namespace nsfw
{
	...
	*/
	...
	public:
		...
		// additionally loads geometry shader
		bool loadShader(const char *name, const char *vpath, const char *fpath, const char *gpath);
